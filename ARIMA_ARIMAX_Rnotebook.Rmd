...
Finalmente, se realiza una gráfica del pronóstico agregando la curva de correspondiente al conjunto de prueba con el fin de visualizar y comparar tanto el pronóstico como los datos reales.
```{r}
