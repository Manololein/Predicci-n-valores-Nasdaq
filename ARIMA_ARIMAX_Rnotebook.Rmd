...
Para finalizar el modelo de ARIMA, se guardan las variables utilizadas en otras con nombres diferentes, esto para continuar utilizando los mismos nombres a continuación en el modelo ARIMAX
```{r}
fc_arima  <- fc
fc2_arima <- fc2
fc3_arima <- fc3
